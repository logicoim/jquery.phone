...
(function() {
  var $, checkForCountryChange, formatBackPhone, formatForwardPhone, formatFromPhone, formatPhone, formats, formattedPhone, hasTextSelected, reFormatPhone, replaceFullWidthChars, restrictInput, safeVal,
    __slice = [].slice;
  ...
  $.phone.fn.init = function(options) {
    ...
    this.on('keypress', restrictInput);
    this.on('keyup', formatForwardPhone);
